...
let runAllTests () =
  ...
  let report = 
    [runTest (sqsum, [], 0, 1, "sqsum 1");
     ...
     runTest (sqsum, [-1;1;-3;4], 27, 1, "sqsum 4");
     ...
     runTest (wrap_curried_2 pipe, ([(fun x -> x); (fun x-> 2*x)], 2), 4, 1, "pipe 4");
     ...
     runTest(wrap_curried_2 sepConcat, ("X",["hello";"hi"]), "helloXhi", 1, "sepConcat 5");
     ...
     runTest(wrap_curried_2 stringOfList, ((fun x -> x^"h"),["foo";"boo"]), "[fooh; booh]",1,"stringOfList 4");
     ...
     runTest(wrap_curried_2 padZero, ([],[9;9]), ([0;0],[9;9]),1,"padzero 3");

     runTest(removeZero, [0;0;0;1;0;0;2], [1;0;0;2],1,"removeZero 1");
     runTest(removeZero, [9;9], [9;9],1,"removeZero 2");
     runTest(removeZero, [0;0;0;0;0], [],1,"removeZero 3");
     ...
     runTest(wrap_curried_2 bigAdd,  ([2;3;4],[9;9;9]), [1;2;3;3],1, "bigAdd 3");

     runTest(wrap_curried_2 mulByDigit,  (9,[9;9;9;9]), [8;9;9;9;1],1, "mulByDigit 1");
     runTest(wrap_curried_2 mulByDigit,  (5,[2;0;0;0]), [1;0;0;0;0],1, "mulByDigit 2");
     ...
     runTest(wrap_curried_2 bigMul,  ([1;2;3;4;5;6],[1;2;3]), [1;5;1;8;5;0;8;8],1,"bigMul 3");
     ] in
